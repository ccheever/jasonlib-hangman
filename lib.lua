...
function THEME(newTheme)
  ...
  elseif theme == "retro" then
    ...
    network.async(
      function()
        filter_effect = moonshine(moonshine.effects.glow).--.chain(moonshine.effects.pixelate)
        chain(moonshine.effects.crt).chain(moonshine.effects.scanlines)
  ...
  elseif theme == "sketch" then
    ...
    network.async(
      function()
        filter_effect =
          moonshine(moonshine.effects.sketch).chain(moonshine.effects.fastgaussianblur).chain(
  ...
  elseif theme == "virtualboy" then
    ...
    network.async(
      function()
        filter_effect =
          moonshine(moonshine.effects.glow).chain(moonshine.effects.pixelate).chain(moonshine.effects.scanlines)
  ...
  elseif theme == "lofi" then
    ...
    network.async(
      function()
        filter_effect =
          moonshine(moonshine.effects.glow).chain(moonshine.effects.fastgaussianblur).chain(moonshine.effects.godsray)
        filter_effect.fastgaussianblur.taps = 3
